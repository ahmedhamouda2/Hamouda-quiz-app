...
function selectCategory (){
    ...
    fetch(`https://opentdb.com/api.php?amount=10&category=${categoryEle.value}&difficulty=${difficultyLocal || 'easy'}&type=multiple`)
    .then(response => {
...
fetch(`https://opentdb.com/api.php?amount=10&category=${categoryLocal || 9}&difficulty=${difficultyEle.value}&type=multiple`)
    .then(response => {
        return response.json();
    })
    .then(data => {
